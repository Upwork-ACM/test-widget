...
import WidgetComponent from './direflow-components/widget-component';

WidgetComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('widget-component is mounted on the DOM', element);
});
